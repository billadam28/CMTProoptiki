 ...
 * @author thodo
 */
public class ProjectPlanningCostSrvlt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((session == null) || (session.getAttribute("userId") == null)) {
            ...
            projectPlan.populateAllocateCostList(id);           
            ...
            this.getServletConfig().getServletContext().getRequestDispatcher("/pages/view_planning_cost.jsp").forward(request, response);
