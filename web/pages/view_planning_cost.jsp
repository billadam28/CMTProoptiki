                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody> 
                                            <tr>
                                             ...
                                             <%int i=0;%>
                                             <%if (projectPlan.getAllocateCostList().isEmpty() == false) {
                                                for (AllocateUtility obj : projectPlan.getAllocateCostList()) { %>  
                                            
                                                <tr>
                                                    <td class="text-primary"><i><b><%=obj.getFirstname()%><br><%=obj.getSurname()%></b></i></td>
                                                    <% for (int j=0; j<=diffMonth; j++) { %>
                                                    <td style="width:auto;">
                                                        <input class="form-control" name="<%=obj.getId()%>" style="width:80px;" value="<%=obj.getAllocateCostList().get(j)%>" readonly="readonly">
                                                    </td>
                                                    <%}%>
                                                </tr>
                                            <% i++; }%>
